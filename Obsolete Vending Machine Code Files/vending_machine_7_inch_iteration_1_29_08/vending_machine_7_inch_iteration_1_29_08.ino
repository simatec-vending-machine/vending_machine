...
NexPage admin_login = NexPage(5, 0, "admin_login");
  ...
  NexText text_user_id_5 = NexText(5, 4, "text_user_id");
...
void bn_phone_1PopCallback(void *ptr)
{
  text_phone_no.getText(current_input,10);
  strcpy(current_input,current_input + 1);
  text_phone_no.setText(current_input);
}
...
bn_phone_1.attachPop(bn_phone_1PopCallback);
