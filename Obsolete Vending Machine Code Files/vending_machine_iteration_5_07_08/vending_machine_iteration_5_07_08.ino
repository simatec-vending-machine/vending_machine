...
NexPage confirm_trans = NexPage(2, 0, "con_trans");
  NexButton bn_home_2 = NexButton(2, 1, "bn_home_2");
  NexButton bn_con_details = NexButton(2, 4, "bn_con_details");

  NexButton bn_phone_1 = NexButton(2, 13, "bn_phone_1");
  NexButton bn_phone_2 = NexButton(2, 14, "bn_phone_2");
  NexButton bn_phone_3 = NexButton(2, 15, "bn_phone_3");
  NexButton bn_phone_4 = NexButton(2, 16, "bn_phone_4");
  NexButton bn_phone_5 = NexButton(2, 17, "bn_phone_5");
  NexButton bn_phone_6 = NexButton(2, 18, "bn_phone_6");
  NexButton bn_phone_7 = NexButton(2, 19, "bn_phone_7");
  NexButton bn_phone_8 = NexButton(2, 20, "bn_phone_8");
  NexButton bn_phone_9 = NexButton(2, 21, "bn_phone_9");
  NexButton bn_phone_0 = NexButton(2, 22, "bn_phone_0");
  NexButton bn_phone_ok = NexButton(2, 23, "bn_phone_ok");
  NexButton bn_phone_cl = NexButton(2, 24, "bn_phone_cl");

  NexButton bn_amount_1 = NexButton(2, 25, "bn_amount_1");
  NexButton bn_amount_2 = NexButton(2, 26, "bn_amount_2");
  NexButton bn_amount_3 = NexButton(2, 27, "bn_amount_3");
  NexButton bn_amount_4 = NexButton(2, 28, "bn_amount_4");
  NexButton bn_amount_5 = NexButton(2, 29, "bn_amount_5");
  NexButton bn_amount_6 = NexButton(2, 30, "bn_amount_6");
  NexButton bn_amount_7 = NexButton(2, 34, "bn_amount_7");
  NexButton bn_amount_8 = NexButton(2, 35, "bn_amount_8");
  NexButton bn_amount_9 = NexButton(2, 36, "bn_amount_9");
  NexButton bn_amount_0 = NexButton(2, 32, "bn_amount_0");
  NexButton bn_amount_ok = NexButton(2, 31, "bn_amount_ok");
  NexButton bn_amount_cl = NexButton(2, 33, "bn_amount_cl");
...
bool text_phone_no_keypad_state = 0;
bool text_amount_keypad_state = 0; 
...
{
  if (text_phone_no_keypad_state == 0)
  {
...
void text_amountPopCallback(void *ptr)
{
  if (text_amount_keypad_state == 0)
  {
    text_amount_keypad_show();
  }
  else
  {
    text_amount_keypad_hide();
  }
}
void text_phone_no_keypad_show()
{
  sendCommand("vis 255, 0");
  sendCommand("confirm_trans.pic=20");
}
void text_phone_no_keypad_hide()
{
  sendCommand("vis 255, 0");
  sendCommand("confirm_trans.pic=19");  
}
void text_amount_keypad_show()
{
  
}
void text_amount_keypad_hide()
{
